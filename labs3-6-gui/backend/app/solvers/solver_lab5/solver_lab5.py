...
def solve_interpolation(x, y, inter_point):
    ...
    graphs = [
        DataForGraph(name=lagrange['name'], x=lagrange['x'], y=lagrange['y']),
        DataForGraph(name=newton_1['name'], x=newton_1['x'], y=newton_1['y']),
        DataForGraph(name=newton_2['name'], x=newton_2['x'], y=newton_2['y']),
        DataForGraph(name=stirling['name'], x=stirling['x'], y=stirling['y']),
        DataForGraph(name=bessel['name'], x=bessel['x'], y=bessel['y']),
    ]
